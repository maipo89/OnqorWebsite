...
if (have_rows('other_services')): 
    while (have_rows('other_services')): 
        ...
        // Filter out the current page from the children array
        $children = array_filter($children, function($child) use ($current_page_id) {
            return $child->ID !== $current_page_id;
        });
                ...
                <div class="other-services__wrapper">
                    ...
                    <div class="other-services__sub">
                        ...
                        <?php foreach ($children as $child): ?>
                            ...
                            ?>
                            <div class="other-services-js other-services__sub__items other-services__sub__items--slider" data-tab="<?php echo $tabIndex; ?>">
